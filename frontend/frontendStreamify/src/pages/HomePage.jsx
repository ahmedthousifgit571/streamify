...
const HomePage = () => {
  ...
  const [pendingRequests, setPendingRequests] = useState(new Set()) // Track requests in progress
  ...
  const recommendedUsers = recommendedUsersData?.recommendedUser || []
  ...
  const {mutate:sendRequestMutation, isPending} = useMutation({
    ...
    onSuccess: (data, userId) => {
      // Update the outgoingRequestsIds set immediately
      ...
      // Still invalidate the query for consistency
          ...
          loadingUsers ? (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              {recommendedUsers.map((user) => {
               ...
               const isDisabled = hasRequestBeenSent || isRequestPending || isPending
